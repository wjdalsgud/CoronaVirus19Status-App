...
public class Daegu extends Activity {
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.daegu); //대구 화면 출력

        TextView daeguText = (TextView) findViewById(R.id.Daegu_API);
        daeguText.setText(((MainActivity) MainActivity.mContext).getDaegu()); //MainActivty에서 파싱한 코로나 API 정보값을 해당 텍스트에 출력
