...
public class Ulsan extends Activity {
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.ulsan); //울산 화면 출력

        TextView ulsanText = (TextView) findViewById(R.id.Ulsan_API);
        ulsanText.setText(((MainActivity) MainActivity.mContext).getUlsan()); //MainActivty에서 파싱한 코로나 API 정보값을 해당 텍스트에 출력
