...
public class ChungCheongBuk extends Activity {
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.chungcheongbuk); //충북 화면 출력

        TextView chungcheongbukText = (TextView) findViewById(R.id.Chungcheongbuk_API);
        chungcheongbukText.setText(((MainActivity) MainActivity.mContext).getChungcheongbuk()); //MainActivty에서 파싱한 코로나 API 정보값을 해당 텍스트에 출력
