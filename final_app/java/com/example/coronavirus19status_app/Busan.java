...
public class Busan extends Activity {
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.busan); //부산 화면 출력

        TextView busanText = (TextView) findViewById(R.id.Busan_API);
        busanText.setText(((MainActivity) MainActivity.mContext).getBusan()); //MainActivty에서 파싱한 코로나 API 정보값을 해당 텍스트에 출력
