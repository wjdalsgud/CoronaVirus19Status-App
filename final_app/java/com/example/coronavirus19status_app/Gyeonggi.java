...
public class Gyeonggi extends Activity {
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.gyeonggi); //경기도 화면 출력

        TextView gyeonggiText = (TextView) findViewById(R.id.Gyeonggi_API);
        gyeonggiText.setText(((MainActivity) MainActivity.mContext).getGyeonggi()); //MainActivty에서 파싱한 코로나 API 정보값을 해당 텍스트에 출력
