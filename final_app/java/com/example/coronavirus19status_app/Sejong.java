...
public class Sejong extends Activity {
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.sejong); //세종 화면 출력

        TextView sejongText = (TextView) findViewById(R.id.Sejong_API);
        sejongText.setText(((MainActivity) MainActivity.mContext).getSejong()); //MainActivty에서 파싱한 코로나 API 정보값을 해당 텍스트에 출력
