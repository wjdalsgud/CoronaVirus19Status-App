...
public class Jeollanam extends Activity {
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.jeollanam); //전라남도 화면 출력

        TextView jeollanamText = (TextView) findViewById(R.id.Jeollanam_API);
        jeollanamText.setText(((MainActivity) MainActivity.mContext).getJeollanam()); //MainActivty에서 파싱한 코로나 API 정보값을 해당 텍스트에 출력
